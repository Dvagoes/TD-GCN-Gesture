...
drop_intv = 2 # drop every frame on this interval
...
for i in range(Samples_sum): # 遍历每一个样本
    ...
    T = (end_frame - begin_frame + 1) - np.floor((end_frame - begin_frame + 1) / drop_intv) # 单个样本的帧数
    ...
    # print (skeleton_data)
    skeleton_data = skeleton_data[begin_frame::drop_intv, :] # should drop every nth frame if i have understood things correctly
    # print (skeleton_data)
